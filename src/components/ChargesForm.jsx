    ...
    <div className="rounded-2xl bg-gray-800 p-4 text-center shadow">
      ...
      <div className="grid grid-cols-4 gap-3">
        <label className="flex flex-col">
          <span className="mb-1 text-sm text-gray-300">Tax %</span>
          <input
            type="number"
            min="0"
            step="0.1"
            className="rounded border border-gray-600 bg-gray-700 px-3 py-2 text-gray-100 placeholder-gray-300"
            value={charges.taxPct}
            onChange={(e) => set("taxPct", e.target.value)}
          />
        </label>
        <label className="flex flex-col">
          <span className="mb-1 text-sm text-gray-300">Service %</span>
          <input
            type="number"
            min="0"
            step="0.1"
        ...
        <label className="flex flex-col">
          <span className="mb-1 text-sm text-gray-300">Disc (Rp)</span>
          <input
            type="number"
            min="0"
            step="100"
        ...
        <label className="flex flex-col">
          <span className="mb-1 text-sm text-gray-300">Tip %</span>
          <input
            type="number"
            min="0"
            step="0.1"
